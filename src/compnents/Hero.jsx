...
import pro2 from "../react-portfolio-assets-kevin-main/assets/pro2.jpg";
      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            ...
            transition={{duratiion: 1 , delay:1.2}} className="max-w-xs lg:max-w-sm rounded-full" src={pro2} alt="piyush" />
          </div>
        </div>
      </div>
    </div>
